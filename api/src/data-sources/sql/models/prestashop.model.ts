...
export class PrestashopModel {
    private static instance: PrestashopModel | null = null;
    ...
    public static getInstance() {
        if (PrestashopModel.instance) {
            return PrestashopModel.instance;
        }
        return (PrestashopModel.instance = new PrestashopModel());
    }
